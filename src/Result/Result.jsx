...
export default function Result({zipCodeData, resetQuiz}) {
    ...
    const resultsSummary = `Your footprint ${zipCodeData.householdFootPrint > usAvg ? 'higher' : 'lower'} than the United States average${zipCodeData.householdFootPrint > usAvg ? '' : ', Nice Job!'}`
